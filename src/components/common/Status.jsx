...
export default function Status() {
  ...
  return (
    status &&
    <div className={`border border-gray-100/50 rounded-[10px] md:w-1/4 w-3/4 fixed top-1/2 left-1/2 -translate-1/2 p-2 ${status.status === true ? 'bg-green-500/30 text-white' : 'bg-red-500/30 text-white'}    `}>
